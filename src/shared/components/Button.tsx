...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    ...
    success: 'bg-emerald-brand text-white hover:bg-emerald-600 shadow-sm hover:shadow-glow-emerald',
    danger: 'bg-crimson-brand text-white hover:bg-red-600',
  ...
  const sizes = {
    ...
    xl: 'text-lg px-8 py-3.5 h-14 gap-3 font-bold',
  };
